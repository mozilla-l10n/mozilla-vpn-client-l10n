...
check_target_language.py --path <base_l10n_folder>
 ...
 language code differs from their Pontoon folder (see PONTOON_TO_VPN in
 locale_config.py). The reference locale is skipped.
"""
...
def main():
    ...
    for locale in locales:
        expected = PONTOON_TO_VPN.get(locale, locale).replace("_", "-")
